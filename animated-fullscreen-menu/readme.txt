...
* [Schema.org](https://schema.org/SiteNavigationElement) (SiteNavigationElement) Structure (SEO)
...
2. Render Menu button as a Block
3. Demo Animation
4. Demo Hover Animation
5. Dropdown functionality
6. Menu Settings - General
7. Menu Settings - Design/Appearance
